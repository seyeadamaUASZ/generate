...
export class ToolbarComponent implements OnInit, AfterViewInit {
  ...
  updateInscriptionActive() {
    this.paramService.updateInscriptionActive(this.inscriptionActive).subscribe(data => {
      this.translate.get('operation reussi').subscribe((res: string) => {
        this.notification.success(res);
      });
    })
  }
