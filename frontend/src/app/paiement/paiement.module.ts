...
import { InfosPayeurComponent } from './components/infos-payeur/infos-payeur.component';
...
@NgModule({
  declarations: [MainContentPaiementComponent,PaiementAppComponent, DetailPaiementComponent, InfosPayeurComponent, PaiementRedirectComponent, MestransactionsComponent],
  imports: [
    CommonModule,
