...
public class Rapport implements Serializable {
    ...
    @ManyToOne(targetEntity = QrCode.class)
    @JoinColumn(name = "rpt_qrc_id", referencedColumnName = "qrc_id", insertable = true, updatable = true)
    private QrCode rptQrcId;
    ...
    public QrCode getRptQrcId() {
        return rptQrcId;
    }

    public void setRptQrcId(QrCode rptQrcId) {
        this.rptQrcId = rptQrcId;
    }
