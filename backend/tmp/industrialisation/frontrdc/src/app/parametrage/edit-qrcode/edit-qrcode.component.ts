...
export class EditQrcodeComponent implements OnInit {
  ...
  QrcodeForm = this.formbuild.group({
    ...
    qrcCouleur: ['', Validators.required],
    qrcForme: ['', Validators.required],
    qrcContenu: ['', Validators.required],
  });
...
console.log(this.donnee)
    this.QrcodeForm.setValue({
      ...
      qrcCouleur: this.qrcode.qrcCouleur ? this.qrcode.qrcCouleur : null,
      qrcForme: this.qrcode.qrcForme ? this.qrcode.qrcForme : null,
      qrcContenu: this.qrcode.qrcContenu ? this.qrcode.qrcContenu : null,
