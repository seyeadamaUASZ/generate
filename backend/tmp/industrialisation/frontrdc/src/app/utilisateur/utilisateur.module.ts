...
import { EditLogoCompteComponent } from './components/edit-logo-compte/edit-logo-compte.component';
...
@NgModule({
  declarations: [UtilisateurAppComponent, DroitAccesComponent,
    ...
    MainContentUtilComponent, ChangePwdComponent, DroitAccesComponent, AjoutMenuComponent, MonCompteComponent, RolesComponent, AddroleComponent, EditroleComponent, AllocateroleComponent, ViewroleComponent, EditCompteComponent, EditLogoCompteComponent, ParametreComponent],
  imports: [
    ChartsModule,
    CommonModule,
