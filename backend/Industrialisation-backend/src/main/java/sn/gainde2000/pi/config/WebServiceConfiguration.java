...
public class WebServiceConfiguration {
	...
	@Bean(name = "IRegistSignPort")
	public IRegistSignPort efacturaConsultasClient() {
		JaxWsProxyFactoryBean jaxWsProxyFactory = new JaxWsProxyFactoryBean();
		jaxWsProxyFactory.setServiceClass(IRegistSignPort.class);
		...
		return (IRegistSignPort) jaxWsProxyFactory.create();
	}
