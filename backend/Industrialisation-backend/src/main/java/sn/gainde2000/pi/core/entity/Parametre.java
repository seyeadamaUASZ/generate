...
public class Parametre implements Serializable{
    ...
    private String paramColorPrimary;
    private String paramColorSecondary;
    ...
    /**
     * @return the paramColorPrimary
     */
    public String getParamColorPrimary() {
        return paramColorPrimary;
    }

    /**
     * @param paramColorPrimary the paramColorPrimary to set
     */
    public void setParamColorPrimary(String paramColorPrimary) {
        this.paramColorPrimary = paramColorPrimary;
    }

    /**
     * @return the paramColorSecondary
     */
    public String getParamColorSecondary() {
        return paramColorSecondary;
    }

    /**
     * @param paramColorSecondary the paramColorSecondary to set
     */
    public void setParamColorSecondary(String paramColorSecondary) {
        this.paramColorSecondary = paramColorSecondary;
    }
