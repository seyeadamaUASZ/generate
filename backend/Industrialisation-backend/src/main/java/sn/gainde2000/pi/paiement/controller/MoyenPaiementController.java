...
public class MoyenPaiementController {
    ...
    //fonction de récupération des moyens de paiement
    ...
    //fonction de cryptage du message reçu envoyé à opay
    ...
    //fonction de décryptage du message encodé reçu opay
    ...
    //Décrypte le message reçu de opay et envoie une notification au payeur pour informer le statut de la transaction
    ...
    //fonction de récupération des certificats
    ...
    //enlève les caractères spéciaux sur les données encodées
