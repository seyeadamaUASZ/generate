    ...
    public void report(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                Qrcode.generateQRCodeImageFichier("Nom: " + rapport.getRptNom() + "\n"
                        + "Description: " + rapport.getRptDescription(), app.getFolderqrcodelogo());
                ByteArrayOutputStream os = new ByteArrayOutputStream();
                ImageIO.write(Qrcode.generateQRCodeImageFichier("Nom: " + rapport.getRptNom() + "\n"
                        + "Description: " + rapport.getRptDescription(), app.getFolderqrcodelogo()), "png", os);
                rapport.setQrcode(os.toByteArray());
