	   			...
	   			JsonObject json = (JsonObject) ja.get(i);
	   			     ...
	   			     if(json.get("code").getAsString().equals("TextBox"))  {
	   			    	myWriter.write(" <mat-form-field appearance=\"fill\">\r\n" + 
		   						...
		   						"          <input matInput placeholder=\"{{ '"+composant.toLowerCase()+"."+json.get("name").getAsString().toLowerCase()+"' | translate }}\" type=\"text\"\r\n" + 
...
<<<<<<< HEAD
	   			    	myWriter.write(" <mat-form-field appearance=\"fill\">\r\n" + 
		   						"          <mat-icon matSuffix></mat-icon>\r\n" + 
		   						"          <input matInput placeholder=\"{{ '"+composant.toLowerCase()+"."+json.get("name").getAsString().toLowerCase()+"' | translate }}\" type=\"checkbox\"\r\n" + 
		   						"            formControlName=\""+json.get("name").getAsString().toLowerCase()+"\" required >\r\n" + 
		   						"        </mat-form-field>\r\n");
=======
	   			    	myWriter.write(" <label>{{ '"+composant.toLowerCase()+"."+json.get("name").getAsString().toLowerCase()+"' | translate }}</label>\r\n" + 
		   						"          <input type=\"checkbox\"\r\n" + 
		   						"            formControlName=\""+json.get("name").getAsString().toLowerCase()+"\" required  >\r\n");
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
	   			    }
	   			    	...
	   			    	myWriter.write(" <mat-form-field appearance=\"fill\">\r\n" + 
		   						"          <mat-icon matSuffix></mat-icon>\r\n" + 
		   						"          <input matInput placeholder=\"{{ '"+composant.toLowerCase()+"."+json.get("name").getAsString().toLowerCase()+"' | translate }}\" type=\"radio\"\r\n" + 
		   						"            formControlName=\""+json.get("name").getAsString().toLowerCase()+"\" required >\r\n" + 
		   						"        </mat-form-field>\r\n");
	   			    }
<<<<<<< HEAD
...
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
	   			    	...
	   			    	JsonArray option= json.getAsJsonArray("options");
		   			    	...
		   			    	myWriter.write("  <mat-form-field appearance=\"fill\">\r\n" + 
		   			    			"             <mat-icon matSuffix>"+json.get("name").getAsString().toLowerCase()+"</mat-icon>\r\n" + 
		   			    			"                  <mat-select placeholder=\"{{ '"+composant.toLowerCase()+"."+json.get("name").getAsString().toLowerCase()+"' | translate }}\" formControlName=\""+json.get("name").getAsString().toLowerCase()+"\"required>\r\n");
		   			     for(int j=0; j<option.size(); j++) {
		   		   			JsonObject op = (JsonObject) option.get(j);
		   		   		System.out.print(op.get("value").getAsString());
		   			    		myWriter.write("<mat-option  value=\""+op.get("value").getAsString()+"\">"+op.get("value").getAsString().toLowerCase()+"</mat-option>\r\n");
		   			    	}
...
<<<<<<< HEAD
	 public void updateComponentListHtml(String composant,String nomProjet,JsonArray ja,JbpmFormInfos formInfos, String  workflow) {
=======
...
<<<<<<< HEAD
			  myWriter.write(" <button mat-mini-fab color=\"primary\" class=\"add-contact\" (click)=\"openDialogAdd()\"\r\n" + 
=======
			    ...
			    for(int i=0; i<ja.size(); i++) {
		   			JsonObject json = (JsonObject) ja.get(i);
		  			             ...
		  			             if(json.get("code").getAsString().equals("Document")) {
		  			              ...
		  			              myWriter.write("<ng-container matColumnDef=\""+json.get("name").getAsString().toLowerCase()+"\">\r\n" + 
		  			            		  "        <th mat-header-cell *matHeaderCellDef mat-sort-header>{{'"+json.get("name").getAsString().toLowerCase()+"' | translate}} </th>\r\n" + 
...
<<<<<<< HEAD
						...
						myWriter.write("                    <mat-menu #detail=\"matMenu\">\r\n" + 
								"                        <button mat-menu-item (click)=\"executer(element)\">\r\n" + 
								"\r\n" + 
								"                            <mat-icon matTooltip=\"{{'Action.executer' | translate}}\" color=\"primary\">settings\r\n" + 
...
<<<<<<< HEAD
	 public void updateComponentList(String composant,String nomProjet, JsonArray ja,JbpmFormInfos formInfos,String workflow) {
=======
...
=======
			  		 for(int i=0; i<listform.size(); i++) {
			  			 myWriter.write("\n\r"
			  			 		...
			  			 		"     if( this.task.data[i].poOwner==localStorage.getItem(\"profil\") && this.task.data[i].tskFormName=='"+uppercasefunct.capitalize(listform.get(i).getJfrmFormulaire())+"'){\r\n" + 
			  			 		"     this."+listform.get(i).getJfrmFormulaire().toLowerCase()+"=true\r\n");
			  			 		if(listform.get(i).getJfrmPrimaire()) {
			  			 		 myWriter.write("this.list"+uppercasefunct.capitalize(composant)+"();\r\n");
			  		 			}
			  			 	      myWriter.write(" this."+listform.get(i).getJfrmFormulaire().toLowerCase()+"Service.getStatus(this.task.data[i].tskId).subscribe((data:any)=>{\r\n" + 
...
<<<<<<< HEAD
						...
						myWriter.write("{ path: '"+forms.get(i).getJfrmFormulaire().toLowerCase()+"', component:"+uppercasefunct.capitalize(forms.get(i).getJfrmFormulaire())+"Component },\r\n");
					}
=======
...
<<<<<<< HEAD
	 	                		filejavagettersetter = filejavagettersetter+ "public Long getId() {\r\n" + 
	 	   	 	            		...
	 	   	 	            		"	}   \r\n" + 
	 	   	 	            		"\n";
	 	                		filejavagettersetter = filejavagettersetter+ "public Long getProcessInsId() {\r\n" +            
		 	   	 	            		"		return processInsId;\r\n" + 
		 	   	 	            		"	}\r\n" + 
		 	   	 	            		...
		 	   	 	            		"	}   \r\n" + 
		 	   	 	            		"\n";
	 	                		filejavagettersetter = filejavagettersetter+ "public Long getTaskInfId() {\r\n" +            
		 	   	 	            		"		return taskInfId;\r\n" + 
		 	   	 	            		"	}\r\n" + 
		 	   	 	            		"	public void setTaskInfId(Long taskInfId) {\r\n" + 
		 	   	 	            		"		this.taskInfId = taskInfId;\r\n" + 
		 	   	 	            		"	}   \r\n" + 
		 	   	 	            		"\n";
	 	                		
	 	                		filejavagettersetter = filejavagettersetter+ "public String getStatus() {\r\n" +            
		 	   	 	            		"		return status;\r\n" + 
		 	   	 	            		"	}\r\n" + 
	 	                		...
	 	                		filejavagettersetter = filejavagettersetter+ "public Long getTaskId() {\r\n" +            
		 	   	 	            		"		return taskId;\r\n" + 
		 	   	 	            		"	}\r\n" + 
		 	   	 	            		"	public void setTaskIdr(Long taskId) {\r\n" + 
		 	   	 	            		"		this.taskId = taskId;\r\n" + 
		 	   	 	            		"	}   \r\n" + 
		 	   	 	            		"\n";
...
=======
	                    "public interface "+uppercasefunct.capitalize(nomrepo)+"Repository extends JpaRepository<"+uppercasefunct.capitalize(nomrepo)+", Long> {\n"
	                    		+ "	 @Query(\"SELECT s from "+uppercasefunct.capitalize(nomrepo)+" s WHERE s.status IN (SELECT t.tskStatusId from Task t WHERE t.poOwner=:poOwner )\")\r\n" + 
	                    	  ...
	                    	  "	   Soumission getOne"+uppercasefunct.capitalize(nomrepo)+"(@Param(\"id\") Long id);" +
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
	                    "\n" +
	                    "}";
