...
<<<<<<< HEAD
import sn.gainde2000.pi.core.service.IJbpmTaskDonneeService;
...
import sn.gainde2000.pi.core.service.impl.JbpmTaskEntreeServiceImpl;
=======
import sn.gainde2000.pi.core.service.IJbpmUserService;
import sn.gainde2000.pi.core.service.IWorkflowService; 
...
<<<<<<< HEAD
    @Autowired
    IJbpmTaskEntreeService jbpmTaskEntreeService;
    @Autowired
    IJbpmTaskDonneeService jbpmTaskDonneeService;
=======
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
    @Autowired
...
<<<<<<< HEAD
    @GetMapping("jbpmtasktntreelist")
     public ServeurResponse getAllJbpmtasktntree() {
          Iterable<JbpmTaskEntree> jbpmTaskEntree = jbpmTaskEntreeService.getListJbpmTaskEntree();
          ServeurResponse response = new ServeurResponse();
          if (jbpmTaskEntree == null) {
               ...
               response.setData(jbpmTaskEntree);
               response.setDescription("Données récupérées.");
          }
          return response;
     }
     
      @RequestMapping(value = "jbpmtasktntree", method = RequestMethod.POST)
      @ResponseBody
     public Object create(@RequestParam("workflow") String workflow, @RequestParam("formglobal") String formglobal,@RequestParam("docname") String docname ) {
        ...
        JSONObject obj = new JSONObject(workflow);
               ...
               Long taskidtocast = 1L;
               
                String pass = ""; 
                String jbpmusername = "";
                jbpmusername = (String) obj.get("taskactualowner").toString();
                String container;
                ...
                taskidtocast = Long.valueOf(taskIdCast);
                String processid;
                ...
                idprocessInst = Long.valueOf(processInsIdCast);
                 ...
                 JbpmTaskEntree TaskEntree = new JbpmTaskEntree();
                 TaskEntree.setcontainer(container);
                 TaskEntree.setJbpmusername(jbpmusername);
                 TaskEntree.setProssid(processid);
                 TaskEntree.setTaskId(taskidtocast);
                 TaskEntree.setProcessInstId(idprocessInst);
                 TaskEntree.setTaskformvalues(formglobal);
                 TaskEntree.setJbpmfichier(docname);
                     jbpmTaskEntreeService.save(TaskEntree); 
                       response.setStatut(true);
                       response.setDescription(" JbpmTaskEntree");
                       response.setData("ok");
     ...
     @GetMapping("jbpmtasklist")
     public Object GetJbpmTaskDonne() { 
         Object taskdata = jbpmTaskDonneeService.GetJbpmProcessInstanceId();
        return taskdata;
     }
=======
