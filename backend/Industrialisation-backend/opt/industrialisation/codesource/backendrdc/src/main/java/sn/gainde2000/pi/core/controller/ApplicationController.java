...
public class ApplicationController {
     ...
     public ServeurResponse publishingApp(HttpServletRequest request, @RequestParam("appImg") MultipartFile file) {
    	 ...
    	 Long applicationId;
			...
			if(app == null) {
<<<<<<< HEAD
				return new ServeurResponse(false,"application.publication.notification.notFound",null);
=======
...
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
				...
				try {
					...
					e.printStackTrace();
<<<<<<< HEAD
					return new ServeurResponse(false,"application.publication.notification.saveError",null);
=======
...
<<<<<<< HEAD
    	 return new ServeurResponse(true,"application.publication.notification.publicationOK",app);
=======
...
<<<<<<< HEAD
    	 return new ServeurResponse(true,"",applicationRepository.listApplicationPubliee());
=======
...
>>>>>>> cf53ab128c96f59e7b5aad2c66c2204fb8fd9422
     ...
     public ServeurResponse unpublishingApp(@RequestBody Application application) {
    	 ...
    	 if(applicationRepository.findByappId(application.getAppId()) != null) {
    	  ...
    	  if(application != null)
<<<<<<< HEAD
    		  return new ServeurResponse(true,"application.publication.notification.depublierOK",application);
    	  else
         	  return new ServeurResponse(false,"application.publication.notification.depublierError",application);
